...
# This here will include Chapter 3 (that is updated in its own file) in the document.
```

***

```{r child = "chapter4.Rmd"}
# This here will include Chapter 4 (that is updated in its own file) in the document.
```

***

```{r child = "chapter5.Rmd"}
# This here will include Chapter 5 (that is updated in its own file) in the document.
```
